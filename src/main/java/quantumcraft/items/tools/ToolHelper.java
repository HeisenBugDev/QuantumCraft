...
public class ToolHelper {
    ...
    public static boolean onBlockDestroyed(ItemStack par1ItemStack, World par2World, int par3, int par4, int par5,
                                           int par6, EntityLivingBase par7EntityLivingBase, IQEnergizable item) {
